...
- [HackerRank](https://www.hackerrank.com/)- You can practice Algorithms, Data Structures, Mathematics, C, C++, Java, Python, Ruby, Linux Shell, Functional Programming, Artificial Intelligence, SQL, Databases, Regex. As well as topic wise problems like arrays, linklist etc.
- [HackerEarth](https://www.hackerearth.com/)- Similar to hackerrank. Solve code challenges to help companies find innovative solutions for their businesses. Also this is the biggest platform for programming and technical screening tests with companies like Google.
...
## Other
-[Seanprashad](https://seanprashad.com/leetcode-patterns/) - leetcode 170 questions based on companies
